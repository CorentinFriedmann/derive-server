...
window.I18N = {
  fr: {
    ...
    honestyShare: '<strong>Partage :</strong> "Partager" génère un vrai <em>lien</em> (peacetrip.com/s/...) vers une page dédiée à cet itinéraire, et l\'ouvre dans le partage natif de l\'appareil ou le copie dans le presse-papiers. L\'export télécharge en plus un fichier .txt.',
    ...
    shareCopyFailed: 'Copie automatique indisponible — voici le lien :',
    shareLinkError: 'Lien de partage indisponible pour le moment.',
  ...
  en: {
    ...
    honestyShare: '<strong>Sharing:</strong> "Share" generates a real <em>link</em> (peacetrip.com/s/...) to a dedicated page for that itinerary, and opens it in your device\'s native share sheet or copies it to your clipboard. The export additionally downloads a .txt file.',
    ...
    shareCopyFailed: "Automatic copy isn't available — here's the link:",
    shareLinkError: 'Sharing link is unavailable right now.',
